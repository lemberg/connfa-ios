...
+ (MFSideMenuShadow*)shadowWithView:(UIView*)shadowedView {
  MFSideMenuShadow* shadow =
      [MFSideMenuShadow shadowWithColor:[UIColor blackColor]
                                 radius:10.0f
                                opacity:0.75f];
...
+ (MFSideMenuShadow*)shadowWithColor:(UIColor*)color
...
- (void)show {
  ...
  self.shadowedView.layer.shadowPath =
      [UIBezierPath bezierPathWithRect:pathRect].CGPath;
