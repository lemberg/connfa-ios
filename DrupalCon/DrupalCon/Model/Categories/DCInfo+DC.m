...
+ (DCInfoCategory*)DC_parseInfoCategoriesFromDictionary:(NSDictionary*)categoryDict inContext:(NSManagedObjectContext *)context
{
    DCInfoCategory * category = (DCInfoCategory*)[[DCMainProxy sharedProxy] objectForID:[categoryDict[kDCInfoCategoryId] intValue]
    ...
    else // update
    {
        ...
        category.order = [NSNumber numberWithFloat:[categoryDict[kDCParseObjectOrderKey] floatValue]];
    }
    return category;
}
